            ...
            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              ...
              <div class="p-6">
                ...
                <div class="flex items-center flex-wrap ">
                  <a class="text  inline-flex items-center md:mb-2 lg:mb-0 text-[#21654E]" href="https://the-summit-gear.web.app/">
                   Live site
                    <svg
                      class="w-4 h-4 ml-2"
                      viewBox="0 0 24 24"
          ...
          <div class="p-4 md:w-1/3">
            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              ...
              <div class="p-6">
                ...
                <div class="flex items-center flex-wrap">
                  <a class="text-[#21654E] inline-flex items-center md:mb-2 lg:mb-0" href="https://hilly-view.web.app/">
                    Live site
                    <svg
                      class="w-4 h-4 ml-2"
                      viewBox="0 0 24 24"
          ...
          <div class="p-4 md:w-1/3">
            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              ...
              <div class="p-6">
                ...
                <div class="flex items-center flex-wrap ">
                  <a class="text-[#21654E] inline-flex items-center md:mb-2 lg:mb-0">
                    Live site
                    <svg
                      class="w-4 h-4 ml-2"
                      viewBox="0 0 24 24"
